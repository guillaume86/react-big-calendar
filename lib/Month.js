...
var _MonthEventRow = require('./MonthEventRow');

var _MonthEventRow2 = _interopRequireDefault(_MonthEventRow);

var _MonthEventEndingRow = require('./MonthEventEndingRow');

var _MonthEventEndingRow2 = _interopRequireDefault(_MonthEventEndingRow);
...
var _MonthBackgroundCells = require('./MonthBackgroundCells');

var _MonthBackgroundCells2 = _interopRequireDefault(_MonthBackgroundCells);
...
var propTypes = _extends({}, _MonthEventRow2.default.PropTypes, {
  ...
  manualLayout: _react2.default.PropTypes.bool,
...
var MonthView = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var _props = this.props,
        ...
        month = _dates3.default.visibleDays(date, culture),
    ...
    return _react2.default.createElement(
      'div',
      { className: (0, _classnames2.default)('rbc-month-view', className), ref: function ref(r) {
          return _this2._view = r;
        } },
      _react2.default.createElement(
        'div',
        { className: 'rbc-row rbc-month-header', ref: function ref(r) {
            return _this2._header = r;
          } },
  ...
  renderWeek: function renderWeek(week, weekIdx, content) {
    ...
    var weekHeight = Math.abs((viewHeight - headerHeight) / this._weekCount);
  ...
  renderBackground: function renderBackground(row, idx) {
    ...
    var self = this;
    var backgroundPropGetter = this.props.backgroundPropGetter;


    function onSelectSlot(_ref2, ev) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'tbody',
          null,
          _react2.default.createElement(_MonthBackgroundCells2.default, {
            rtl: this.props.rtl,
            slots: row,
  ...
  renderRowLevel: function renderRowLevel(segments, week, idx) {
    ...
    return _react2.default.createElement(_MonthEventRow2.default, _extends({}, this.props, {
  ...
  renderShowMore: function renderShowMore(segments, extraSegments, week, weekIdx) {
    ...
    return _react2.default.createElement(_MonthEventEndingRow2.default, _extends({}, this.props, {
      eventComponent: this.props.components.event,
      onSelect: this.handleSelectEvent,
      onShowMore: onClick,
  ...
  _headers: function _headers(row, format, culture) {
    ...
    var children = _dates3.default.range(first, last, 'day').map(function (day, idx) {
      return _react2.default.createElement(
        'th',
        {
          key: 'header_' + idx,
  ...
  _measureRowLimit: function _measureRowLimit() {
    var viewHeight = (0, _height2.default)(this._view);
    var headerHeight = (0, _height2.default)(this._header);
  ...
  _dateClick: function _dateClick(date, e) {
    ...
    if (this.props.onDateClick) {
      (0, _helpers.notify)(this.props.onDateClick, [date, e]);
    } else {
  ...
  _selectDates: function _selectDates(ev) {
